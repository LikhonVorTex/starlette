...
////////////====[MUTE]====////////////
if(strpos(strtolower($message), "/chn ") === 0 || strpos(strtolower($message), "!chn ") === 0 || strpos(strtolower($message), ".chn ") === 0 ){
