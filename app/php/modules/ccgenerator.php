...
//        $headers[] = 'Accept: */*';
//        $headers[] = 'Referer: http://www.ke1.nl/en/checker/';
//        $headers[] = 'X-Requested-With: XMLHttpRequest';
//        $headers[] = 'Connection: keep-alive';
//        $options = array(
//                        CURLOPT_URL => 'http://www.ke1.nl/en/checker/api.php',
        ...
        for ($i = 0; $i < $howMany; $i++) {
            if ($this->check == true){
                ...
                if ($check->error == 1){
                    ...
                    $this->Save("Log/Result-" . $this->bin . ".txt", $card . "\n");
                } else if ($check->error == 2){
                    echo $card . $this->color("red", " >> DIE\n");
                } else if ($check->error == 3){
                    echo $card . $this->color("white", " >> UNKNOWN\n");
                } else {
